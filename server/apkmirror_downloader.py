...
def get_latest_version_download_link() -> Optional[str]:
    ...
    print(versions)
    # url = f"{apk_mirror_url}/apk/whatsapp-inc/whatsapp/whatsapp-{versions[0]}-release/whatsapp-messenger-{versions[0]}-android-apk-download/"  # noqa: E501
    url = MAKO_DOWNLOAD_TEMPLATE.format(apk_mirror_url, versions[0], versions[0])
...
if __name__ == "__main__":
    download_latest("whatsapp-latest.apk")
